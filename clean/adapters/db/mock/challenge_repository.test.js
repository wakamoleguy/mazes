  ...
  describe('add', () => {
    ...
    it('should contain the challenge in the new repo', (done) => {
      repo
        .add(challenge)
        .then((newRepo) =>
          newRepo.browseByChallenger(challenge.challengingUser)
        )
    ...
    it('should not add the challenge to the old repo', (done) => {
      repo
        .add(challenge)
        .then(() => repo.browseByChallenger(challenge.challengingUser))
        .then((foundChallenges) => {
