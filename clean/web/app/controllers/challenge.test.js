...
describe('Challenge controller', () => {
  ...
  beforeEach(() => {
    req = {}
    res = jasmine.createSpyObj('res', ['render', 'sendStatus', 'redirect'])
  ...
  describe('browse', () => {
    beforeEach(() => {
      spyOn(challengeUseCases, 'browseByParticipant').and.returnValue(
        Promise.resolve({
          sent: [1, 2, 3],
          received: [4, 5, 6]
        })
    ...
    it('should fetch challenges', (done) => {
      controller.browse(req, res, () => {
        expect(challengeUseCases.browseByParticipant).toHaveBeenCalledWith(
          ned.id,
          jasmine.any(Object)
        )
  ...
  describe('accept', () => {
    beforeEach(() => {
      ...
      spyOn(challengeUseCases, 'accept').and.returnValue(Promise.resolve())
    })
  ...
  describe('run', () => {
    beforeEach(() => {
      ...
      spyOn(challengeUseCases, 'readRunMaze').and.returnValue(
        Promise.resolve(1)
      )
    })
  ...
  describe('postTime', () => {
    beforeEach(() => {
      ...
      spyOn(challengeUseCases, 'postTime').and.returnValue(Promise.resolve())
    })
